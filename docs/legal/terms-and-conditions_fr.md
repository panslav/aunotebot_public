...
4.2. Vous confirmez disposer des droits et de la base légale nécessaires pour traiter ce Contenu via le Service.  

4.3. Vous accordez au Propriétaire une licence non exclusive, mondiale et gratuite pour héberger, traiter, transformer, transmettre et stocker le Contenu uniquement afin d'exploiter, sécuriser et améliorer le Service.  

4.4. Vous ne devez pas soumettre de contenu violant les droits de tiers ou la loi.

## 5. Utilisation Autorisée et Interdictions

5.1. Vous acceptez d'utiliser le Service de manière légale et de bonne foi.  

5.2. Vous ne devez pas utiliser le Service pour :
- enfreindre des lois ou règlements ;
...
7.2. Le Propriétaire peut ajouter, modifier, limiter, suspendre ou supprimer des fonctionnalités à tout moment sans préavis.  

7.3. Le Propriétaire peut introduire à tout moment des fonctionnalités payantes, des quotas, des limites d'utilisation ou des abonnements.

## 8. Suspension et Résiliation

8.1. Le Propriétaire peut suspendre ou résilier l'accès immédiatement en cas de suspicion d'abus, de risque juridique, de violation des règles, de problème de sécurité ou de raison opérationnelle.  

8.2. Le Propriétaire peut retirer ou limiter du Contenu lorsque la loi, la politique, le risque technique ou les exigences de plateforme l'imposent.  

8.3. L'Utilisateur peut cesser d'utiliser le Service à tout moment.

## 9. Exclusion de Garanties

9.1. Aucune garantie n'est donnée quant à la continuité, la sécurité, l'absence d'erreur ou l'adéquation à un usage particulier du Service.  

9.2. Le Propriétaire ne garantit pas la conservation, la disponibilité, la portabilité ou la récupération du Contenu.  

9.3. Le Service ne constitue pas un conseil juridique, financier, médical ou professionnel.

## 10. Limitation de Responsabilité

10.1. Dans la mesure maximale permise par la loi, le Propriétaire n'est pas responsable des dommages indirects, accessoires, spéciaux, consécutifs, exemplaires ou punitifs.  

10.2. Cela inclut notamment la perte de bénéfices, de données, de réputation, d'opportunités commerciales ou les interruptions de service.  

10.3. Si la responsabilité ne peut être exclue en vertu de la loi, elle est limitée au minimum autorisé par la loi applicable.

## 11. Indemnisation

11.1. Vous acceptez d'indemniser et de dégager de toute responsabilité le Propriétaire pour toute réclamation, perte, responsabilité, coût ou dépense (y compris frais juridiques) résultant de :
...
13.2. Tout litige sera soumis aux juridictions compétentes d'Espagne, sauf dispositions impératives de protection des consommateurs applicables.
